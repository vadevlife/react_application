...
const cardContent=[{
  ...
  nome:'Prodesp',
  cargo:'Dev. Front-End',
  desc:'Em uma grande equipe, minha função foi criar e desenvolver através de fluxogramas, \n\n aplicações responsivas com frameworks de interface e recursos JavaScript.',
